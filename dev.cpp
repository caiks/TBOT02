...
void TBOT02::recordsPersistent(Record& r, std::ostream& out)
{
...
void TBOT02::recordListsPersistent(RecordList& rr, std::ostream& out)
{
	for (auto& r : rr)
		recordsPersistent(r, out);
}

std::unique_ptr<RecordList> TBOT02::persistentsRecordList(std::istream& in)
{
...
Bitmap TBOT02::bminsert(const Bitmap& bm2, int ox, int oy, const Bitmap& bm1)
{
	Bitmap bm3(bm2);
...
Bitmap TBOT02::bmborder(int b, const Bitmap& bm)
{
	return bminsert(Bitmap(b * 2 + bm.height, b * 2 + bm.width, 255), b, b, bm);
}

Bitmap TBOT02::bmhstack(const std::vector<Bitmap>& ll)
{
	if (!ll.size())
	{
...
Bitmap TBOT02::bmvstack(const std::vector<Bitmap>& ll)
{
	if (!ll.size())
	{
...
void TBOT02::bmwrite(string imageFileName, const Bitmap& bm)
{
	try
	{
...
Bitmap TBOT02::historyRepasBitmap(int c, int d, const HistoryRepa& hr)
{
...
Bitmap TBOT02::historyRepasBitmapUncentred(int c, int d, const HistoryRepa& hr)
{
	int n = (int)hr.dimension;
	int z = (int)hr.size;
	Bitmap bm(z*c, n);
...
Bitmap TBOT02::historyRepasBitmapAverage(int c, int d, const HistoryRepa& hr)
{
	int n = (int)hr.dimension;
	int z = (int)hr.size;
	Bitmap bm(c, n);
...
SystemHistoryRepaTuple TBOT02::recordListsHistoryRepa(int d, const RecordList& qq)
{
...
SystemHistoryRepaTuple TBOT02::recordListsHistoryRepaRegion(int d, int n, int s, const RecordList& qq0, int event_start, int event_end)
{
	auto lluu = listsSystem_u;
	auto uuur = systemsSystemRepa;
...
SystemHistoryRepaTuple TBOT02::recordListsHistoryRepa_2(int d, const RecordList& qq)
{
	auto lluu = listsSystem_u;
...
SystemHistoryRepaTuple TBOT02::recordListsHistoryRepa_3(int d, const RecordList& qq)
{
	auto lluu = listsSystem_u;
...
SystemHistoryRepaTuple TBOT02::recordListsHistoryRepa_4(int d, const RecordList& qq)
{
	auto lluu = listsSystem_u;
	auto hrjoin = vectorHistoryRepasJoin_u;
...
SystemHistoryRepaTuple TBOT02::recordListsHistoryRepa_5(int d, const RecordList& qq)
{
	auto lluu = listsSystem_u;
...
SystemHistoryRepaTuple TBOT02::recordListsHistoryRepa_6(int d, const RecordList& qq)
{
	auto lluu = listsSystem_u;
	auto hrjoin = vectorHistoryRepasJoin_u;
